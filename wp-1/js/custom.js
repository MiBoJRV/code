jQuery(document).ready(function(){
    ...
    /*add caret to dropdown menu*/
        ...
        jQuery('nav .menu-item-has-children').each( function(){
            jQuery(this).append('<span class="thereCaret"><img src="http://localhost:8888/sites/wpffr/wp-content/uploads/2023/09/menu-arr.svg" title="" alt=""/></span>')
        })
        /*open on hover or click*/
        if (jQuery(window).innerWidth() > 1199) {
            ...
            jQuery('nav .menu-item-has-children .thereCaret').click(function(){
                ...
                // jQuery('nav .menu-item-has-children').parent().find('ul:first').toggleClass('openMenu');
