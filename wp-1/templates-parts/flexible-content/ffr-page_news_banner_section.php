<?php global $pageBannerNewsFFR;
$pageBannerNewsFFR++; ?>
<section
        class="page-banner_2 page-banner_2-ffr-<?php echo $pageBannerNewsFFR; ?> <?php echo get_sub_field('custom_class'); ?>">
    ...
    <?php if ($pageBannerNewsFFR < 2): ?>
        <style>
            ...
            .page-banner_2-image {
                ...
                <?php endif; ?>
                right: 130px;
                <?php if(get_sub_field('right_position_image') != ''):?>
                    right: <?php echo get_sub_field('right_position_image'); ?>px;
                <?php endif; ?>
                width: calc(100% - 600px);
                <?php if(get_sub_field('image_max_width') != ''):?>
                     max-width: <?php echo get_sub_field('image_max_width'); ?>px;
                <?php endif; ?>
            }
